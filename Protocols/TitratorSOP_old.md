...
11. <a name="Troubleshooting"></a> **Troubleshooting**
  1. If labX is unable to connect and there is an error saying LabX cannot connect to the server do the following:
    1. search services in the search button on the bottom left side of the home screen
    1. Click on the Services app
    1. Scroll down on the local services to find LabX and make sure LabX is started. If not, click LabXHostService and click start
    1. Reopen LabX and it should open more quickly.
