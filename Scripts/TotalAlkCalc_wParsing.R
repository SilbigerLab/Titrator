...
path<-"Data/Bermuda27_29" #the location of all your titration files
massfile<-"Mass_3_29_2018all.csv" # name of your file with masses
titrationfile<-'Titrations-3_29_2018-Silbiger TA (EP)r1.csv'# name of the last titration file run
