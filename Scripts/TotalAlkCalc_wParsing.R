...
path<-"Data/CRMTest2" #the location of all your titration files
massfile<-"Mass-3_13_2018.csv" # name of your file with masses
titrationfile<-'Titrations-3_13_2018.csv'# name of the last titration file run
