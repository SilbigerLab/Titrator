...
path<-"Data/Tena/Meso_20240723"
massfile<-"Mass_20240723.csv" # name of your file with masses
titrationfile<-"Titrations-07_23_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
