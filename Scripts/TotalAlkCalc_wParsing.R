...
path<-"Data/Moorea_March2022/04112022" #the location of all your titration files

massfile<-"CHighNightMass_04112022.csv" # name of your file with masses

titrationfile<-'Titrations-4_11_2022-Silbiger TA (EP)r1.csv'# name of the last titration file run
