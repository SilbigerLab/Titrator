...
path<-"Data/Tena/Meso_20241220"
massfile<-"Mass_20241220.csv" # name of your file with masses
titrationfile<-"Titrations-12_20_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
