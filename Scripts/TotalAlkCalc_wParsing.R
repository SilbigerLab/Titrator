...
path<-"Data/Hawaii_Samples_20190909/" #the location of all your titration files

massfile<-"Mass_20190909.csv" # name of your file with masses

titrationfile<-'Titrations-9_9_2019-Silbiger TA (EP)r1.csv'# name of the last titration file run
