...
path<-"Data/Bermuda32_34" #the location of all your titration files
massfile<-"Mass_4_23_2018all.csv" # name of your file with masses
titrationfile<-'Titrations-4_23_2018-Silbiger TA (EP)r1.csv'# name of the last titration file run
