...
path<-"Data/Tena/Meso_20241218"
massfile<-"Mass_20241218.csv" # name of your file with masses
titrationfile<-"Titrations-12_18_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
