...
path<-"Data/Tena/Meso_20240831"
massfile<-"Mass_20240831.csv" # name of your file with masses
titrationfile<-"Titrations-08_31_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
