...
path<-"Data/Tena/Meso_20240722"
massfile<-"Mass_20240722.csv" # name of your file with masses
titrationfile<-"Titrations-07_22_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
