...
path<-"Data/Moorea_Jan_02182019/" #the location of all your titration files
massfile<-"Mass_02182019.csv" # name of your file with masses
titrationfile<-'Titrations-2_18_2019-Silbiger TA (EP)r1.csv'# name of the last titration file run
