...
path<-"Data/Tena/Meso_20240815"
massfile<-"Mass_20240815.csv" # name of your file with masses
titrationfile<-"Titrations-08_15_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
