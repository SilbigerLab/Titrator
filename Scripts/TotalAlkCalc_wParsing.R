...
path<-"Data/Tena/Meso_20240601"
massfile<-"Mass_20240601.csv" # name of your file with masses
titrationfile<-"Titrations-06_01_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
