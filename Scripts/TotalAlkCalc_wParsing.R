...
path<-"Data/Tena/Meso_20240408"
massfile<-"Mass_20240408b.csv" # name of your file with masses
titrationfile<-"Titrations-04_08_2024b-Silbiger TA (EP)r1.csv" #<-name of last titration file run
