...
path<-"Data/CRMTest3" #the location of all your titration files
massfile<-"Mass_3_14_2018.csv" # name of your file with masses
titrationfile<-'Titrations-3_14_2018-Silbiger TA (EP)r1.csv'# name of the last titration file run
