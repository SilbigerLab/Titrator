...
path<-"Data/Tena/Meso_20241217"
massfile<-"Mass_20241217.csv" # name of your file with masses
titrationfile<-"Titrations-12_17_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
