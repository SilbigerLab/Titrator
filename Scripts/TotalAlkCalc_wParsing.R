...
path<-"Data/Tena/Meso_20241219"
massfile<-"Mass_20241219.csv" # name of your file with masses
titrationfile<-"Titrations-12_19_2024-Silbiger TA (EP)r1.csv" #<-name of last titration file run
