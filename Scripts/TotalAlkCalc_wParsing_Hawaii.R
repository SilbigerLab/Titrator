...
path<-"Data/Chapuis/Tidepools/Sandy_20251105"
massfile<-"mass_20251113_part2.csv" # name of your file with masses
titrationfile<-"Titration-11_13_2025_part2.csv" #<-name of last titration file run
