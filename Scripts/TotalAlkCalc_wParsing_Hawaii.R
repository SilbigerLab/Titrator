...
path<-"Data/Powell/BioFac_7April2026_0000_051426"
massfile<-"mass_051426.csv" # name of your file with masses
titrationfile<-"Titration-5_14_2026.csv" # name of your titration file run
date<- '5/14/2026' # Date that the data were run
