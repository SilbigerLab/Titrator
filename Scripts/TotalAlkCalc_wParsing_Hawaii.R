...
path<-"Data/Chapuis/Tidepools/Kaihalulu_20250608"
massfile<-"mass_20250610.csv" # name of your file with masses
titrationfile<-"Titration-6_10_2025.csv" #<-name of last titration file run
