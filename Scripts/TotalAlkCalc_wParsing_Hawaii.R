...
path<-"Data/Chapuis/DiamondHead_20250223"
massfile<-"mass20250224.csv" # name of your file with masses
titrationfile<-"Titration-2_24_2025.csv" #<-name of last titration file run
