...
path<-"Data/Chapuis/Tidepools/Sandy_20260222"
massfile<-"mass_20260223.csv" # name of your file with masses
titrationfile<-"Titration-2_23_2026.csv" #<-name of last titration file run
