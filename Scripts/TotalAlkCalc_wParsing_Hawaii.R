...
path<-"Data/Chapuis/Sandy_20250413"
massfile<-"mass_20250414.csv" # name of your file with masses
titrationfile<-"Titration-4_14_2025.csv" #<-name of last titration file run
