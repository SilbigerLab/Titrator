...
path<-"Data/Chapuis/Sandy_20250216_2"
massfile<-"mass20250221.csv" # name of your file with masses
titrationfile<-"Titration-2_21_2025.csv" #<-name of last titration file run
