...
path<-"Data/Chapuis/DiamondHead_20250326"
massfile<-"mass_20250328.csv" # name of your file with masses
titrationfile<-"Titration-3_28_2025.csv" #<-name of last titration file run
