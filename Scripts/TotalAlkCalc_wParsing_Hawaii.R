...
path<-"Data/Powell/Test_20260209"
massfile<-"mass_20260209.csv" # name of your file with masses
titrationfile<-"Titration-2_9_2026.csv" #<-name of last titration file run
