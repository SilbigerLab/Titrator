...
path<-"Data/Powell/BioFac_Respo_Run9_Run10_Run11_031926"
massfile<-"mass_031926.csv" # name of your file with masses
titrationfile<-"Titration-3_19_2026.csv" #<-name of last titration file run
