...
path<-"Data/Powell/BioFac_Respo_Run1_Run2_031526"
massfile<-"mass_031526_CRM.csv" # name of your file with masses
titrationfile<-"Titration-3_15_2026_CRM.csv" #<-name of last titration file run
