...
path<-"Data/Powell/BioFac_25March2026_2100_091626"
massfile<-"mass_091626.csv" # name of your file with masses
titrationfile<-"Titration-9_16_2026.csv" # name of your titration file run
