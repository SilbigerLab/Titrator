...
path<-"Data/Chapuis/DiamondHead_20250302"
massfile<-"mass_20250307.csv" # name of your file with masses
titrationfile<-"Titration-3_7_2025.csv" #<-name of last titration file run
