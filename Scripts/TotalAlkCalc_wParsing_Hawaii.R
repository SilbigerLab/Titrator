...
path<-"Data/Chapuis/Tidepools/Kaihalulu_20260228"
massfile<-"mass_20260308_part2.csv" # name of your file with masses
titrationfile<-"Titration-3_8_2026_part2.csv" #<-name of last titration file run
